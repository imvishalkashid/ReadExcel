...
public class Read_Excel {
		    ...
		    for (int i = 0; i < rowCount+1; i++) {
		      ...
		      //Create a loop to print cell values in a row
		        ...
		        for (int j = 0; j < row.getLastCellNum(); j++) {
		            ...
		            //System.out.println(sCell_value);
		            
		            driver.navigate().to(sCell_value);
		            
		            if((driver.getPageSource().contains("Terminator"))&&(driver.getPageSource().contains("Terminator")))
			         {
	...
	//Main function is calling readExcel function to read data from excel file
	    ...
	    private TakesScreenshot TakesScreenshot(WebDriver driver2) {
